$(document).ready(function(){
    ...
    /** FAQ custom */
    $('.package-item-link').on("click", function(){
        var parent = $(this).parents('.package-item');

        $(this).text(function(i, text){
            return text === "подробнее" ? "свернуть" : "подробнее";
        });

        parent.toggleClass('active').find('.package-item-body').slideToggle(600);
